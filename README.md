...
```bash
    python manga_cli.py compare 11 12 13 # sorts the anime passed with highest score and creates a comparison graph (11 12 13 are the mal ids of big 3 animes)
```